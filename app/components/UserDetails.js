...
//If you move the descructuring statement up in the parameter, it will do the variable declaration implicitly.
...
function UserDetails(user){
	...
	return(
		<div>
			{/*
				This is JSX's way of checking if a property exists (the && truthyness)
				!! - if its there, go ahead and render it, if not dont worry about it
...
//Shape allows you to pass proptypes of a nested object
//Some things arent present, so they dont need to be required
